...
var _currentField: PhysicsFieldGD.State
...
func updateRender():
	...
	_currentField = PhysicsFieldGD.buildState()
...
func _process(delta: float) -> void:
	...
	var query = PhysicsFieldGD.RaycastQuery.new()
	...
	var result = PhysicsFieldGD.raycastQuery(_currentField, query)
